...
class Bg extends ModuleBase {
    ...
    async getBg() {
        const { request: { responseURL: bgUrl } } = await axios.head(`https://source.unsplash.com/collection/${this.options.bgCollectionId}/${this.options.bgSize}/`);
